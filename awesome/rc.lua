...
awful.spawn.with_line_callback('bash -c "xset s off && xset -dpms && xset s noblank"', {})
...
awful.screen.connect_for_each_screen(function(s)
	...
	awful.tag.add("", {
		icon = "/usr/share/icons/Papirus/48x48/apps/blobby.svg",
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "r", function()
		awful.spawn.with_shell("/usr/bin/bash ~/.config/rofi/launchers/type-7/launcher.sh")
	end, { description = "Run Rofi Launcher", group = "launcher" }),

	-- Power Menu With Rofi
	awful.key({ modkey, "Control" }, "x", function()
		awful.spawn.with_shell("/usr/bin/bash ~/.config/rofi/powermenu/type-6/powermenu.sh")
...
client.connect_signal("request::titlebars", function(c)
	...
	-- 		awful.titlebar.widget.maximizedbutton(c),
	-- 		awful.titlebar.widget.stickybutton(c),
	-- 		awful.titlebar.widget.on/opbutton(c),
	-- 		awful.titlebar.widget.closebutton(c),
	-- 		layout = wibox.layout.fixed.horizontal(),
	-- 	},
	-- 	layout = wibox.layout.align.horizontal,
